...
export const MASTER_DOSSIER_SECTIONS: MasterDossierSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "• FASE 1: ABERTURA (07h00 às 11h00)",
      "  - 07h00: Paramentação com EPIs limpos (touca 100% dos cabelos, avental impermeável, botas antiderrapantes, unhas curtas e sem adornos). Lavagem e assepsia das mãos por 40 segundos.",
      "  - 07h15: Sanitização de bancadas de inox, tábuas de corte coloridas e cubas GN com álcool 70% e solução desinfetante.",
      "  - 07h30: Auditoria rápida de geladeiras e freezers — checar 100% das etiquetas adesivas e validades; descartar ou isolar qualquer item sem identificação.",
      "  - 08h00: Abastecer o banho-maria do rechaud com água limpa, ligar o aquecimento e certificar temperatura mínima de 70°C.",
      "  - 08h15: Posicionar as 6 preparações base no rechaud: Arroz Branco, Feijão Preto, Baião de Dois, Vatapá, Maniçoba e Arroz Paraense.",
      "  - 08h45: Mise en place de vegetais e guarnições: cebolas em rodelas, limões em 4 partes meia-lua (sem sementes), vinagrete em cubinhos, farofa crocante e brunoise fina de temperos.",
      "  - 09h30: Pré-preparo de proteínas e insumos amazônicos: dessalgue e limpeza de camarão, catação e lavagem de jambu, aquecimento de tucupi e porcionamento de carnes.",
      "  - 10h15: ETIQUETAGEM OBRIGATÓRIA: preencher a Etiqueta Universal (Produto, Data/Hora, Validade Técnica, Executor, Conferente) e colar em cada cuba antes de armazenar.",
      "  - 10h45: Apoiar o Cozinheiro Líder na conferência e assinatura do Formulário de Abertura F-01.",
      "",
      "• FASE 2: SERVIÇO DE PICO E ATENDIMENTO (11h00 às 15h00 / 18h00 às 22h00)",
      ...
      "",
      "• FASE 3: FECHAMENTO E ENCERRAMENTO (15h00 às 15h20 / Fechamento Noturno)",
  ...
  },
  {
    ...
    subtitle: "As 3 Fases fundamentais: Abertura, Serviço de Pico e Fechamento",
    content: [
      "Fase 1: Abertura (Manhã)",
