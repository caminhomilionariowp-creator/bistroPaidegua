...
export const RecipeSheets: React.FC<RecipeSheetsProps> = ({
  ...
  const renderRecipeSheet = (recipe: RecipeTechSheet, isPrintView = false) => (
          <div
            ...
            data-print-fill={isPrintView ? "true" : undefined}
            data-print-safety={isPrintView ? "0.97" : undefined}
            className={`bg-white border-2 border-stone-800 rounded-xl p-6 sm:p-8 print:p-4 shadow-paper relative overflow-hidden${isPrintView ? ' recipe-sheet-print print:flex print:flex-col print:justify-between' : ''}`}
          >
